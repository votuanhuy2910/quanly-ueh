...
if (
    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        $students = getAllStudentsK47($conn);
        ...
        $sql1 = "SELECT status, COUNT(*) as count FROM studentsk47 GROUP BY status";
        ...
        <body>
            ...
            ?>
                <div class="container mt-5" style="max-width: 1600px;">
                    ...
                    $sql_paginated = "SELECT * FROM studentsk47 LIMIT $start, $limit";
                    ...
                    <th scope='col'>Action</th>
                      ...
                      <td><a href='k47-student-view.php?student_id={$student['student_id']}' style='text-decoration: none; text-transform: capitalize;'>{$student['fname']}</a></td>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        const navLinks = document.querySelectorAll("#navLinks li:nth-child(7) a");
