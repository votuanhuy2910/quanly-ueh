...
if (
    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        $sql1 = "SELECT status, COUNT(*) as count FROM students48 GROUP BY status";
        ...
        <body>
            ...
            ?>
                <div class="container mt-5">
                    ...
                    $sql_paginated = "SELECT * FROM students48 LIMIT $start, $limit";
                    ...
                    $sql_total = "SELECT COUNT(*) as total FROM students48";
                    ...
                    if ($students_paginated) {
                        ...
                        foreach ($students_paginated as $student) {
                            echo "<tr>
                                ...
                                <td><a href='k48-student-view.php?student_id={$student['student_id']}' style='text-decoration: none; text-transform: capitalize;'>{$student['fname']} {$student['lname']}</a></td>
