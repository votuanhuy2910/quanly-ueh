                ...
                <div class="mt-5">
                    <nav style="display: flex; align-items: flex-start; justify-content: space-evenly;">
                        ...
                        <div style="display: flex; align-items: center; align-content: center; flex-wrap: wrap; flex-direction: column-reverse; margin-bottom: 2rem;">
                            ...
                            <a href="k3-student-add.php" class="btn btn-dark mt-3">Thêm sinh viên mới</a>

                            <form action="k3-student-search.php" class="n-table" method="get" style="width: 100%;">
                    ...
                    if ($students_paginated) {
                        ...
                        foreach ($students_paginated as $student) {
                            echo "<tr>
                                    ...
                                    <td style='text-align: center;border: 1px solid #ddd; padding: 8px;'><a href='k3-student-view.php?student_id={$student['student_id']}' style='text-decoration: none; text-transform: capitalize; color: #007bff'>{$student['fname']}</a></td>
                                    ...
                                    <td style='display: flex; align-items: center; justify-content: space-evenly; border-right: 1px solid #ddd; padding: 8px;'>
                                        <a href='k3-student-edit.php?student_id={$student['student_id']}' class='btn btn-warning'>Edit</a>
                                        <a href='k3-student-delete.php?student_id={$student['student_id']}' class='btn btn-danger'>Delete</a>
                                    </td>
                                </tr>";
                        }
                        echo "</tbody>";
