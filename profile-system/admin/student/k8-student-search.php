    ...
    if ($_SESSION['role'] == 'Admin') {
        if (isset($_GET['searchKey'])) {
            ...
            if ($search_key === '') {
                ...
                $students = searchStudents8($search_key, $conn);
...
?>
            ...
            <body>
                ...
                ?>
                    <div class="mt-5">
                        <a href="k8-student.php" class="btn btn-dark">Quay lại</a>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #ddd; padding: 8px;">
                                                <a href="k8-student-view.php?student_id=<?= $student['student_id'] ?>" style="text-decoration: none;">
                                                    <?= $student['fname'] ?>
                                                </a>
                                            </td>
...
<?php
            ...
            header("Location: k8-student.php");
            exit;
            // $students = [];
        }
    } else {
