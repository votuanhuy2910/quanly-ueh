    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        if (
            ...
            if (empty($fname)) {
                ...
                header("Location: ../k47-student-edit.php?error=$em&$data");
                exit;
                ...
                header("Location: ../k47-student-edit.php?success=$sm&$data");
                exit;
            }
        } else {
            $em = "Xảy ra lỗi!";
            header("Location: ../k47-student.php?error=$em");
            exit;
        }
    } else {
